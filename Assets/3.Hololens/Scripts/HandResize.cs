...
{
	// This script will be attatched to a small object which is a pin for scaling another object

    public GameObject ObjToResize;
    ...
    {
        InputManager.Instance.PushModalInputHandler(ObjToResize);
        lastScale = ObjToResize.transform.localScale;
    }
    ...
    public void OnManipulationUpdated(ManipulationEventData eventData)
    {
        try
        {
            ...
            else if (resizingEnabled && toolBelt.getState() == ToolBelt.State.SCALE)
            {
    ...
    void Resize(Vector3 newScale)
    {
        ...
        ObjToResize.transform.localScale = Vector3.Lerp(ObjToResize.transform.localScale,
